...
The current public `0.2.0` artifact is available from
[Maven Central](https://central.sonatype.com/artifact/com.vevdb/vev-java/0.2.0)
and the [VevDB release](https://github.com/vevdb/vev/releases/tag/v0.2.0).
